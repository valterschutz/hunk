...
const BUILTIN_COMMANDS = [
  ...
  {
    id: "hunk.review.toggleSelectedHunkVerified",
    title: "Mark the selected hunk as verified, or unmark it",
    category: "review",
    defaultKeys: ["!"],
    locus: "host-only",
    publicToExtensions: true,
  ...
  {
    id: "hunk.view.toggleVerifiedHunks",
    title: "Show or hide verified hunks",
    category: "view",
    defaultKeys: ["V"],
    locus: "client-local",
    publicToExtensions: true,
