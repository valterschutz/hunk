...
const BUILTIN_COMMANDS = [
  ...
  {
    id: "hunk.review.toggleFileContext",
    title: "Show or hide the whole file around its hunks",
    category: "review",
    defaultKeys: ["z"],
    locus: "client-local",
    publicToExtensions: true,
  ...
  {
    id: "hunk.review.acceptSelectedHunk",
    title: "Accept the selected hunk, or clear its decision",
    category: "review",
    defaultKeys: ["+"],
    locus: "host-only",
    publicToExtensions: true,
  ...
  {
    id: "hunk.review.markSelectedHunkAddressed",
    title: "Mark the selected rejected hunk as addressed, or rejected again",
    category: "review",
    defaultKeys: ["="],
    locus: "host-only",
    publicToExtensions: true,
  ...
  {
    id: "hunk.review.openActiveNoteInEditor",
    title: "Open the active note's line in your editor",
    category: "review",
    defaultKeys: ["o"],
    locus: "host-only",
    publicToExtensions: true,
